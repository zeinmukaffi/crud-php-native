...
<body>
    <div class="container mt-5">
        ...
        <table border="1" class="table table-hover table-bordered">
            ...
            <tbody>
                <?php
                    $sql = "SELECT * FROM divisi"; // variable sql biasanya berisikan query yang diperlukan
                    ...
                    echo    "<tr>
                            ...
                            <td>$pel[gaji]</td>
                            <td>
                            <a class='btn btn-warning' href='edit.php?id_divisi=".$pel['id_divisi']."'>Edit</a> |
                            <a class='btn btn-danger' href='delete.php?id_divisi=".$pel['id_divisi']."'>Hapus</a>
                            </td>
                            </tr>";
